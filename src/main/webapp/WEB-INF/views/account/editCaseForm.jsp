    ...
    <fieldset>
        ...
        <table id="contentTable" class="table table-striped table-bordered table-condensed">
            ...
            <c:forEach items="${caseStepOne}"  var="cos">
                <tr>
                    <td><input type='text' name='stepNum' value="${cos.stepNum}"/></td>
                    <td><textarea name='stepDesc' rows='3' col='20'> ${cos.stepDesc}</textarea></td>
                    <td><textarea name='expectedResult' rows='3' col='20'> ${cos.expectedResult}</textarea></td>
                    <td>
                        <input type='button' value='添加' onclick='addStep(this)' />
                        <input type='button' value='删除' onclick='deleteStep(this)'/>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <div class="form-actions">
            <input id="submit_btn" class="btn btn-primary" type="submit" onclick="saveStepList()" value="提交"/>&nbsp;
